...
<div class="container-fluid p-0">
    ...
    <div class="container  ">
        ...
        <div class="d-flex justify-content-center mb-4">
                <a href="../View/category.php" class="btn text-decoration-none px-5 py-3 guideBtn">
                    <div class="">ဆက်လက်ကြည့်ရှုရန်</div>
                </a>
        </div>
            <!-- end category -->
            ...
            <div class="d-flex justify-content-center mb-4">
                <a href="./GuideofWeb.php" class="btn text-decoration-none px-5 py-3 guideBtn">
                    <div class="">စာမျက်နှာအသုံးပြုနည်း ကြည့်ရှုရန်</div>
                </a>
            </div>
            <!-- SERVICES END -->
    ...
    <button id="topBtn" class="pt-2  rounded position-fixed bottom-0 end-0 m-5 border-none">
        <i class="bi bi-arrow-up-circle   fw-bolder fs-4 px-2 "></i>
    </button>
    </div>
</body>
