...
<head>
    ...
    <!--Customize CSS-->
    <link rel="stylesheet" href="./cartPop.css">
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content modal-parent">
                <div class="modal-header cart-header ps-lg-5">
                    <h5 class="modal-title ms-lg-3" id="exampleModalLabel">လူကြီးမင်း၏​စျေးခြင်း(1)</h5>
                    <button type="button" class="btn-close btn-close-dark me-lg-3" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row g-0">
                        <div class="col-lg-3">
                            <img src="./The-beginning-of-attachment-and-the-end-of-forgiveness-1-300x300 13.png" class="img-fluid ps-5 ps-md-0 ps-lg-0" alt=""/>
                        </div>
                        <div class="col-lg-8">
