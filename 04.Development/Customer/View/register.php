                ...
                <form action="" class="">
                    <div class="row my-4">
                        ...
                        <div class="row my-3 justify-content-center">
                            <div class="col-lg-10">
                                <input type="text" placeholder="User Name (English Only)" class="form-control ps-4 pt-2"/>
                            </div>
                        </div>
                        <div class="row my-3 justify-content-center">
                            <div class="col-lg-10">
                            <input type="email" placeholder="Email Address" class="form-control ps-4 pt-2"/>
                            </div>
                        </div>
                        <div class="row my-3 justify-content-center">
                            <div class="col-lg-10">
                            <input type="password" placeholder="Password" class="form-control ps-4 pt-2"/>
                            </div>
                        </div>
                        <div class="row my-3 justify-content-center">
                            <div class="col-lg-10">
                            <input type="password" placeholder="Confirm Password" class="form-control ps-4 pt-2"/>
                            </div>
                        </div>
                        <div class="row my-3 justify-content-center">
                            <div class="col-lg-10">
                            <input type="number" placeholder="Phone Number" class="form-control ps-4 pt-2"/>
                            </div>
                        </div>
                        <div class="row mt-4 mb-3 justify-content-center">
                            <div class="col-lg-10 d-flex justify-content-between">
                                ...
                                <input type="submit" value="အ​ကောင့်ဝင်ရန်" class="btn btn-light px-4 pt-2 text-center login-btn"/>
                            </div>
                        </div>
                </form>
            </div>
