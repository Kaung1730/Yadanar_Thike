<div class="container">
    <nav class="navbar navbar-expand-sm d-none d-lg-block d-md-none mt-3">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav lg-screen text-center">
                    <li class="nav-item nav-color me-4 px-2">
                        <a class="nav-link mt-2 pt-3  text-dark" aria-current="page" href="../View/HomePage.php">မူလစာမျက်နှာ</a>
                    </li>
                    <li class="nav-item py-lg-2 nav-color  me-4 px-4">
                        <a class="nav-link pt-3 text-dark" href="../View/category.php">စာအုပ်များ</a>
                    </li>
                    <li class="nav-item nav-color me-4 px-1">
                        <a class="nav-link mt-2 pt-3 text-dark" href="../View/authorlist.php">စာရေးဆရာများ</a>
                    </li>
                    <li class="nav-item   nav-color me-4 px-1">
                        <a class="nav-link mt-2 pt-3 text-dark" href="../View/login.php">အကောင့်သို့ဝင်ရန်</a>
                    </li>
                ...
                <?php require "../commonLayout/userSetting.php"?>
                <!--Stard of User Setting-->
                <!-- <div class="modal ms-5 ms-lg-0 ms-md-0 fade" id="lg-userSetting" tabindex="-1" aria-labelledby="userSettingLabel" aria-hidden="true">
    ...
    <!--Start md and sm nav-->
    <nav class="navbar navbar-light navbar-expand-lg mt-lg-2 d-block d-md-block d-lg-none">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarNav">
                <div class="row  collapse " id="navbarNav">
                    ...
                    <div class="dropdown col-12 sm-bg py-2">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li>
                                <a class="dropdown-item text-dark text-decoration-none" href="#lg-userSetting" data-bs-toggle="modal">ကိုယ်​ရေးအချက်အလက်များပြင်ဆင်မည်</a>
                            </li>
        ...
        <div class="modal-content modal-parent">
            ...
            <div class="modal-body">
                ...
                <div class="form">
                    ...
                    <div class="col-12 sm-bg py-2 position-relative">
