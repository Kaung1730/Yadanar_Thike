...
<body>
    <img src="../resource/image/contact.png" alt="" class="position-absolute d-none d-md-none d-lg-block"/>
    <div class="container d-flex justify-content-center align-items-center mb-0 mb-md-0 mb-lg-4">
        <div class="left mt-lg-5 mt-md-3 mt-3 pb-2 pb-lg-3 pb-md-2 pe-3 pe-md-4 pe-lg-2 mb-4 mb-md-3 mb-lg-0">
            <div class="title lh-lg ps-5 mt-3">Contact Us</div>

            <div class="facts lh-lg pb-3 ps-5">သင်ဖြည့်စွက်ပြောလိုသည့်အကြောင်းကို ကျွန်ုပ်တို့အား ထပ်မံပြောပြပေးပါ မကြာမီ သင့်ထံ အကြောင်းကြားပေးပါမည်။</div>
