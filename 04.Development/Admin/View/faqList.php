...
<head>
    ...
    <script src="../resource/js/faqList.js"></script>
</head>

<body>
    <?php require "../Controller/faqListController.php" ?>
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="contact-box mt-4">
                        <div class="btn mt-4">
                            <button type="button" class="btn btn-secondary mx-3 btn-2 btn-size"><a href="privacyPolicyList.php" class="a-edit">Privacy & Policy</a></button>
                        ...
                        <nav aria-label="Page navigation example">
                            <a href="faqAdd.php" class="a-edit"><button type="button" class="btn btn-secondary btn-3 mx-5 float-start">Add</button></a>
