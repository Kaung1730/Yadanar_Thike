...
<head>
    ...
    <script src="../resource/js/faqAdd.js"></script>
</head>

<body>
    <div class="container-fluid">
        <form action="../Controller/faqUpdateController.php" method="POST">
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="contact-box mt-4">
                        <div class="btn mt-4">
                            <button type="button" class="btn btn-secondary mx-3 btn-2 btn-size"><a href="privacyPolicyList.php" class="a-edit">Privicy & Policy</a></button>
                            ...
                            <button type="button" class="btn btn-secondary mx-3 btn-1 btn-size"><a href="faqList.php" class="a-edit">FAQ</a></button>
                        </div>
                        <div class="input-part ms-5">
                            <?php require "../Controller/faqEditController.php" ?>
                            <input type="hidden" class="box1 input-edit" name="id" value="<?php echo $result[0]['faq_id'] ?>">
                            ...
                            <textarea type="text" id="address" class="form-control input-edit" aria-describedby="passwordHelpBlock" cols="30" rows="10" name="answer" value="<?php echo $result[0]['answer'] ?>"></textarea>
                            <div class="buttonGp">
