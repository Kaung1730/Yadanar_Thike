...
<body>
    <div class="container-fluid">
        <form action="../Controller/adminAddController.php" method="POST">
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="contact-box mt-4">
                        ...
                        <div class="input-part ms-5">
                            ...
                            <input type="text" id="admin" class="form-control input-edit" aria-describedby="passwordHelpBlock" name="ad_name">
                            <label for="admin" class="form-label mt-2">Admin Email</label>
                            <input type="email" id="admin" class="form-control input-edit" aria-describedby="passwordHelpBlock" name="email">
                            <label for="password" class="form-label mt-2">Password</label>
                            <input type="password" id="password" class="form-control input-edit" aria-describedby="passwordHelpBlock" name="password">
                            ...
                            <button type="submit" class="btn btn-info mt-4 mb-3 btn-4 btn-cen" id="submit">Submit</button>
                        </div>
                    </div>
