<div class="d-flex justify-content-around box_group">
    <div class="total_user">
        <div class="d-flex justify-content-around box">
            ...
            <span class="pt-3 fs-2 text-success fw-bold">5000</span>
        </div>
    ...
    <div class="total_viewers">
        <div class="d-flex justify-content-around box">
            <img src="../resource/img/person icon.png" alt="" class="person_icon pt-3">
            <span class="pt-3 fs-2 text-danger fw-bold">2000</span>
        </div>
    ...
    <div class="income">
        <div class="d-flex justify-content-around box">
            <img src="../resource/img/person icon.png" alt="" class="person_icon pt-3">
            <span class="pt-3 fs-2 text-primary fw-bold">1.5k</span>
        </div>
    ...
    <div class="order">
        <div class="d-flex justify-content-around box">
            <img src="../resource/img/person icon.png" alt="" class="person_icon pt-3">
            <span class="pt-3 fs-2 text-info fw-bold">300</span>
        </div>
