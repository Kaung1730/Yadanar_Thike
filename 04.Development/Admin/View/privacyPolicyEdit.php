...
<body>
    <div class="container-fluid">
        <form action="../Controller/privacyUpdateController.php" method="POST">
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="contact-box mt-4">
                        <div class="btn mt-4">
                            <button type="button" class="btn btn-secondary mx-3 btn-1 btn-size"><a href="privacyPolicyList.php" class="a-edit">Privicy & Policy</a></button>
                        ...
                        <div class="input-part ms-5">
                            <?php require "../Controller/privacyEditController.php" ?>
                            <input type="hidden" class="box1 input-edit" name="id" value="<?php echo $result[0]['pp_id'] ?>">
